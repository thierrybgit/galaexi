...
!----------------------------------------------------------------------------------------------------------------------------------
! Globval variables
INTEGER(C_INT) :: d_Face_xGP 

! Metrics
INTEGER(C_INT) :: d_sJ 

! Metrics on GaussPoints
INTEGER(C_INT) :: d_Metrics_fTilde 
INTEGER(C_INT) :: d_Metrics_gTilde 
INTEGER(C_INT) :: d_Metrics_hTilde 

! Surface vectors
INTEGER(C_INT) :: d_NormVec 
INTEGER(C_INT) :: d_TangVec1 
INTEGER(C_INT) :: d_TangVec2 
INTEGER(C_INT) :: d_SurfElem 
INTEGER(C_INT) :: d_Ja_Face 
INTEGER(C_INT) :: d_Ja_slave 

! Volume/Side mappings
INTEGER(C_INT) :: d_ElemToSide 
INTEGER(C_INT) :: d_SideToElem 
INTEGER(C_INT) :: d_S2V 
INTEGER(C_INT) :: d_S2V2 
