...
CALL ProlongToFace(PP_nVarPrim,PP_N,URec,URec_master,URec_slave,0,0,0,L_Minus,L_Plus,doMPISides=.TRUE.)
...
#endif
CALL ProlongToFace(PP_nVarPrim,PP_N,URec,URec_master,URec_slave,0,0,0,L_Minus,L_Plus,doMPISides=.FALSE.)
