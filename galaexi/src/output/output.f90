...
IF (mins.LT.1 .AND. hours.EQ.0 .AND. days.EQ.0) THEN
  ...
  ELSE
!    WRITE(UNIT_stdOut,'(A,E10.4,A,E10.4,A,A,I4,A1,I0.2,A1,I0.2,A1,I0.2,A2,A,A1,A,A3,F6.2,A3,A1)',ADVANCE=tmpString)    &
    WRITE(UNIT_stdOut,*)    &
...
DO iElem=1,nElems
  ...
  ELSE
    ...
    DO k=0,PP_NZ; DO j=0,PP_N; DO i=0,PP_N
      CALL ConsToPrim(PP_N, UPrim ,U(:,i,j,k,iElem), 0, 0, iElem,i,j,k)
