...
!----------------------------------------------------------------------------------------------------------------------------------
INTEGER(C_INT) :: d_FV_Elems 
INTEGER(C_INT) :: d_FV_Elems_master 
INTEGER(C_INT) :: d_FV_Elems_slave 

INTEGER(C_INT) :: d_FV_U_master GENERATE_DEVICE_KEY
INTEGER(C_INT) :: d_FV_U_slave 
INTEGER(C_INT) :: d_FV_alpha 
