...
USE MOD_DG_Vars,         ONLY: d_UPrim_master
#if PARABOLIC
...
CALL CopyFromDevice(C_LOC(UPrim_master), d_UPrim_master, SIZE_C_DOUBLE, SIZE(UPrim_master))
#if PARABOLIC
CALL CopyFromDevice(C_LOC(gradUx_master),d_gradUx_master,SIZE_C_DOUBLE, SIZE(gradUx_master))
CALL CopyFromDevice(C_LOC(gradUy_master),d_gradUy_master,SIZE_C_DOUBLE, SIZE(gradUy_master))
CALL CopyFromDevice(C_LOC(gradUz_master),d_gradUz_master,SIZE_C_DOUBLE, SIZE(gradUz_master))
#endif
#endif /* USE_ACCEL */
...
DO SideID=1,nBCSides
  ...
  CALL CalcPressureForce(Fp_loc,UPrim_master(PRES,:,:,SideID),SurfElem(:,:,SideID,0),NormVec(:,:,:,SideID,0))
