...
!===================================================================================================================================
SUBROUTINE Jac_Split(U,UPrim,URef,UPrimRef,Metric,MetricRef,dfdu)
! MODULES
USE MOD_Preproc
USE MOD_Globals
...
!===================================================================================================================================
SUBROUTINE Jac_Split_SD(U,UPrim,URef,UPrimRef,Metric,MetricRef,dfdu)
! MODULES
USE MOD_Preproc
USE MOD_Globals
...
!===================================================================================================================================
SUBROUTINE Jac_Split_PI(U,UPrim,URef,UPrimRef,Metric,MetricRef,dfdu)
! MODULES
USE MOD_Preproc
USE MOD_Globals
...
!===================================================================================================================================
SUBROUTINE Jac_Split_FD(U,UPrim,URef,UPrimRef,Metric,MetricRef,dfdu)
! MODULES
USE MOD_Preproc
USE MOD_Globals
USE MOD_SplitFlux     ,ONLY: SplitDGVolume_pointer
...
DO jVar=1,PP_nVar
  ...
  CALL ConsToPrim(PP_N,UPrimTilde,UTilde,0,0,0,0,0,0)
